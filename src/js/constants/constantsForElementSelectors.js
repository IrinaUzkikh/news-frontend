...
const headerMenuMobilAdd = document.querySelector('#headerMenuMobilAdd');

const menuMobilAdd = document.querySelector('#menuMobilAdd');
const menuMobilCloseAdd = document.querySelector('#menuMobilCloseAdd');
const menuLogoutAdd = document.querySelector('#menuLogoutAdd');
